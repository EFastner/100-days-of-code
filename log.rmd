...
**Today's Progress:** Created script for daily updating. Hoping to load onto the Raspeberry Pi tomorrow and create a Chron job to update each day

**Thoughts:** Hopefully building a Chron Job will build a good foundation for updating this in the future
